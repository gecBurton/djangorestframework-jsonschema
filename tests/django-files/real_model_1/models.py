...
class manifest(models.Model):
    ...
    well = models.CharField(
        ...
        primary_key=False,
        max_length=255,
        validators=[("RegexValidator", 'r"^[A-H](0[1-9]|1[1-2])$"')],
    )
    volume_ul = models.IntegerField(
        null=False,
        validators=[
            validators.MinValueValidator(10),
            validators.MaxValueValidator(700),
        ],
        primary_key=False,
    )
    ...
    od_260_280 = models.DecimalField(
        null=False,
    ...
    cancer_sample_y_n = models.CharField(
        null=False,
        primary_key=False,
        max_length=3,
...
class redcap(models.Model):
    GenOMICC = models.CharField(
        null=False,
        primary_key=True,
        max_length=255,
        validators=[("RegexValidator", 'r"^.{4,32}$"')],
    )
    ...
    date_of_identifying_eligibility_for_the_study = models.DateField(
        null=False, primary_key=False,
    )

    responsible_clinician = models.ForeignKey(
        "ResponsibleClinician", null=True, on_delete=models.CASCADE,
    )
...
class ResponsibleClinician(models.Model):
    ...
    address = models.JSONSchemaField(
        schema={
            "type": "object",
            "properties": {
...
class plate(models.Model):
    barcode = models.CharField(
        ...
        primary_key=True,
        max_length=255,
        validators=[("RegexValidator", 'r"^LP\\d{7}-DNA$"')],
    )
