...
class Hospital(models.Model):
    postcode = models.CharField(null=False, primary_key=False, max_length=255, validators=[('RegexValidator', 'r"^[a-z]{1,2}\\d[a-z\\d]?\\s*\\d[a-z]{2}$"')], )
    type = models.CharField(null=False, primary_key=False, max_length=7, choices=[('general', 'general'), ('local', 'local'), ('clinic', 'clinic')], )
