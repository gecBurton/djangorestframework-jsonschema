...
class manifest(models.Model):
    ...
    well = models.CharField(label="physical location of the well on the plate", max_length=255, validators=[('RegexValidator', 'r"^[A-H](0[1-9]|1[1-2])$"')], )
...
class redcap(models.Model):
    ...
    GenOMICC = models.CharField(primary_key=True, max_length=255, validators=[('RegexValidator', 'r"^.{4,32}$"')], )
    sex = models.CharField(max_length=1, choices=[('m', 'm'), ('f', 'f'), ('u', 'u')], )
    nhs_number = models.CharField(max_length=255, validators=[('RegexValidator', 'r"^\\d{3} \\d{3} \\d{4}$"')], )
...
class plate(models.Model):
    ...
    barcode = models.CharField(primary_key=True, max_length=255, validators=[('RegexValidator', 'r"^LP\\d{7}-DNA$"')], )
