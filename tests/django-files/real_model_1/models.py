...
class manifest(models.Model):
    ...
    well = models.CharField(label="physical location of the well on the plate", max_length=255, validators=[validators.RegexValidator(r"^[A-H](0[1-9]|1[1-2])$")], )
...
class redcap(models.Model):
    ...
    GenOMICC = models.CharField(primary_key=True, max_length=255, validators=[validators.RegexValidator(r"^.{4,32}$")], )
...
class plate(models.Model):
    ...
    barcode = models.CharField(primary_key=True, max_length=255, validators=[validators.RegexValidator(r"^LP\d{7}-DNA$")], )
