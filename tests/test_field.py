...
results = {
    ...
    "length": (
        "CharField",
        {"max_length": 3, "validators": [("MinLengthValidator", 2)], "null": False, 'primary_key': False},
    ),
    "regular_expressions": (
        "CharField",
        {
    ...
    "integer": ("IntegerField", {"validators": [], "null": False, 'primary_key': False}),
    "enum": (
        "CharField",
        {
            "max_length": 1,
    ...
    "id": ("UUIDField", {"primary_key": True, "default": "uuid.uuid4", 'primary_key': False}),
}
